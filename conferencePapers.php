...
session_start();
$sql = "SELECT * from conferencePapers";
        ...
        <div class="col-sm-12 text-left">
            <div class="entry">
                ...
                <?php if ($_SESSION['account'] != null) {
                    ?>
                    <button type="submit"><a href="conferencePapersAdd.php">新增</a></button>
                    <?php
                }
                ?>
                        ...
                        if ($count % 2 == 1) {
                            ...
                            <tr class="odd">
                                ...
                                if ($_SESSION['account'] != null) {
                                    echo "<form name=\"form\" method=\"post\" action=\"conferencePapersEdit.php\">";
